...
void CEdgeBrowserAppDlg::ResizeEverything()
{
    ...
    if (m_ctrlPic.m_hWnd != NULL)
    {
        m_ctrlPic.GetClientRect(&availableBounds);
        //ClientToScreen(&availableBounds);
    }
...
HRESULT CEdgeBrowserAppDlg::OnCreateEnvironmentCompleted(HRESULT result, ICoreWebView2Environment* environment)
{
    ...
    m_webViewEnvironment->CreateCoreWebView2Controller(m_ctrlPic.GetSafeHwnd(), Microsoft::WRL::Callback<ICoreWebView2CreateCoreWebView2ControllerCompletedHandler>(this, &CEdgeBrowserAppDlg::OnCreateCoreWebView2ControllerCompleted).Get());
...
HRESULT CEdgeBrowserAppDlg::OnCreateCoreWebView2ControllerCompleted(HRESULT result, ICoreWebView2Controller* controller)
{
    if (result == S_OK)
    {
        ...
        HRESULT hresult = m_webView->Navigate(L"https://www.naver.com");
